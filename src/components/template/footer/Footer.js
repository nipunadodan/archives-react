            ...
            <footer className="md:rounded-2xl bg-archives px-8 md:px-16 py-14 md:p-16 mt-6 md:mb-6 text-white block w-full">
                ...
                <div className="my-14 md:grid md:grid-cols-3 gap-4">
                    <ul className={'col-span-2'}>
                        <li className={'mb-6 md:mb-0'}>Is your article has at least one Sri Lankan author with Sri Lankan institute affiliation?</li>
                        <li className={'mb-6 md:mb-0'}>Is it a conference full paper or abstract, from a conference hosted by a Sri Lankan institute?</li>
